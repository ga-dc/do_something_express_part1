...
app.get('/:id', listsController.show);
app.get('/:id/:task_id', tasksController.show);
app.post('/', listsController.create);
app.post('/:id', tasksController.create);
app.put('/:id/:task_id', tasksController.update);
app.delete('/:id', listsController.delete);
app.delete('/:id/:task_id', tasksController.delete);
...
// app.put('/:id', listsController.update);
